...
struct RFC1035_MessageHeader
{
    ...
    inline u_int8_t get_rd()const{ return flags_hi & 1; }
    ...
    inline void set_nscount(u_int16_t nscount){ nscount_hi = nscount >> 8; nscount_lo = (u_int8_t)nscount; }
    inline u_int16_t get_arcount()const{ return arcount_lo + (((u_int16_t)arcount_hi) << 8); }
    inline void set_arcount(u_int16_t arcount){ arcount_hi = arcount >> 8; arcount_lo = (u_int8_t)arcount; }
};
...
// parsing not implememted
struct RFC1035_NAPTR_RR : public RFC1035_RR
{
};
...
// parsing not implememted
struct RFC1035_SRV_RR : public RFC1035_RR
{
};
...
#define RFC1035_TYPE_SRV            33
#define RFC1035_TYPE_NAPTR         35
